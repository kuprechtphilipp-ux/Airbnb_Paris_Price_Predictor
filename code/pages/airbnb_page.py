...
def airbnb_page():
    ...
    try:
        geojson_path_relative = "code/data/paris.geojson" 
    ...
    #Error handling
        ...
        st.error(f"Error: GeoJSON file not found at expected path: {geojson_path_relative}. Map cannot be rendered.")
    ...
    with st.sidebar:
        ...
        try:
            data_arrondissement_occupancy = pd.read_csv("code/data/occupancy_arrondissement.csv")
